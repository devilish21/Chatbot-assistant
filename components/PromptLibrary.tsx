                                ...
                                {snippets.length === 0 ? (
                                    ...
                                    snippets.map(snippet => (
                                        <div 
                                            ...
                                            className={`p-4 rounded border cursor-pointer group transition-all ${
                                                isTerminalMode 
                        ...
                        <div className="flex flex-col h-full space-y-4">
                            ...
                            <div className="flex-1 flex flex-col">
                                ...
                                <textarea 
                                    ...
                                    className={`flex-1 w-full p-2 rounded bg-transparent border outline-none resize-none font-mono text-xs ${
                                        isTerminalMode 
                                            ? 'border-green-500 text-green-500 placeholder-green-800' 
                                            : 'border-stc-purple/30 text-stc-purple placeholder-stc-purple/30'
                                    }`}
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                <button 
                                    ...
                                    className={`px-4 py-2 text-xs font-bold uppercase rounded ${
                                        isTerminalMode ? 'hover:bg-green-900/30' : 'hover:bg-gray-100'
                                    }`}
                                >
                                    Cancel
                                </button>
