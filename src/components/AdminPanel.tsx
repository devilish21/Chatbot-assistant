            ...
            >
                ...
                <div className={`flex items-center justify-between px-6 py-4 border-b ${isTerminalMode ? 'border-green-500/50 bg-green-900/10' : 'border-stc-purple/10 bg-stc-light'}`}>
                    ...
                    <div className="flex gap-2">
                        {isAuthenticated && (
                            <button
                                onClick={() => { onClose(); onOpenMetrics(); }}
                                className={`text-[10px] font-bold uppercase px-3 py-1 rounded border animate-in fade-in ${isTerminalMode ? 'border-green-500 text-green-500 hover:bg-green-500 hover:text-black' : 'border-stc-purple text-stc-purple hover:bg-stc-purple hover:text-white'
                                    }`}
                            >
                                Open DB Portal
                            </button>
                ...
                {!isAuthenticated ? (
                    ...
                    <form onSubmit={handleLogin} className="p-8 flex flex-col gap-6">
                        ...
                        <button
                            type="submit"
                            className={`w-full py-3 font-bold uppercase tracking-wider rounded transition-all mt-2 ${isTerminalMode
                        ...
                        <div className={`w-48 border-r flex flex-col ${isTerminalMode ? 'border-green-500/30 bg-green-900/5' : 'border-stc-purple/10 bg-stc-light'}`}>
                            {[
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-3 px-4 py-4 text-xs font-bold uppercase tracking-wide text-left transition-colors ${activeTab === tab.id
