                ...
                <div className={`flex items-center justify-between mb-1 ${titleClass}`}>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {onRetry && !isLoading && (
                            <button
                                onClick={onRetry}
                                className={`p-1 rounded-full transition-colors ${isTerminalMode ? 'hover:bg-green-900/40 text-green-600 hover:text-green-400' : 'hover:bg-gray-100 text-gray-400 hover:text-stc-purple'}`}
